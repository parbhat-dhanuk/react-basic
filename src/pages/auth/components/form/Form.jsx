...
<div className="divide-y divide-gray-200">
                        ...
                        </div>
                   {
                    type === 'Register' && (
                        <div className="relative">
                        <input onChange={handleChange} autoComplete="off" id="username" name="username" type="text" className="peer placeholder-transparent h-10 w-full border-b-2 border-gray-300 text-gray-900 focus:outline-none focus:borer-rose-600" placeholder="username address" />
            ...
            {
                type==="Register"?<Link to="/login">Go to login</Link>:<Link to="/register">Go to register</Link>
            }
        </div>
    </div>
</div>
